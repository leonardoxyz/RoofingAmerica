...
const Login = (props) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('https://localhost:7089/api/Authentication/login', credentials);
        ...
        <>
            <form className="form_container" onSubmit={handleLogin}>
                <div className="title_container">
                    <p className="title">Faça Login ou Registre uma nova conta!</p>
                    <span className="subtitle">Você precisa estar logado para ter acesso.</span>
                </div>
                <br />
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className="input_field" id="email_field" value={credentials.email} onChange={(e) => setCredentials({ ...credentials, email: e.target.value })} />
                </div>
                <div className="input_container">
                ...
                <Link to="/register" className="sign-in_btn">
                    <button title="Sign Up" className="sign-in_btn">
                        <span>Registrar</span>
                    </button>
                </Link>
